...
export class SanitizePipe implements PipeTransform {
  ...
  public transform(value: string, type: SanitizeType): SanitizeSafeOutput {
    switch (type) {
      case 'html':
...
export type SanitizeType = 'html' | 'resourceUrl' | 'script' | 'style' | 'url';
export type SanitizeSafeOutput = SafeHtml | SafeStyle | SafeScript | SafeUrl | SafeResourceUrl;
